...
export default function OSINTHub() {
  ...
  const handleNFTClick = () => {
    window.open("https://ossint-hub-pass.nfts2.me/", "_blank", "noopener,noreferrer")
  }
              ...
              <div className="bg-background/40 p-6 rounded-lg border border-primary/30 backdrop-blur-sm">
                ...
                <div className="mt-6 text-center">
                  <p className="text-gray-300 mb-4">
                    ...
                    <a
                      href="https://ossint-hub-pass.nfts2.me/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-primary hover:text-primary/80 underline font-semibold"
                    >
                      https://ossint-hub-pass.nfts2.me/
                    </a>{" "}
                  ...
                  <Button
                    onClick={handleNFTClick}
                    className="bg-gradient-to-r from-primary to-blue-600 hover:from-primary/90 hover:to-blue-600/90 text-white font-bold py-3 px-8 rounded-lg cyber-glow transform hover:scale-105 transition-all duration-300"
                  >
              ...
              <div className="flex justify-center">
                <div className="text-center max-w-md">
                  <div className="w-32 h-32 mx-auto mb-4 rounded-full bg-gradient-to-br from-primary/20 to-primary/40 border-2 border-primary/50 flex items-center justify-center cyber-glow overflow-hidden">
                    <Image
                      src="/images/design-mode/tolik-katolik.jpg.jpeg"
                      alt="Anton Goldini"
                      width={128}
                      height={128}
          ...
          <div className="relative z-10 flex flex-col items-center justify-center min-h-[80vh] px-6">
            ...
            <div className="text-center mb-12 text-reveal relative">
              <div className="flex items-center justify-center gap-8 mb-4">
                ...
                >
                  <Image
                    src="/images/osint-identity-card.png"
                    alt="OSINT HUB NFT"
                    width={80}
                    height={140}
